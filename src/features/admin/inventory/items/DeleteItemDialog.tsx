    ...
    try {
      ...
      if (result.success) {
        toast.success("Item Moved to Trash", {
          description: `Item "${item.name}" has been moved to trash.`,
          duration: 5000,
        });
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            <br /><br />
            This item can be restored from the trash section later if needed.
            <br /><br />
            <span className="text-muted-foreground text-xs">
              Note: All stock data and transaction history will be preserved.
            </span>
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
